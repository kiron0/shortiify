...
export default function Contact() {
          ...
          return (
                    <section className="bg-[url('./assets/bg2.jpg')] relative z-10 overflow-x-hidden px-4 md:px-0 py-20 lg:py-[120px] h-screen">
                              <Link to="/" className="absolute top-6 left-4 md:left-6 lg:left-6">
                                        <button className="glass text-white font-bold py-2 px-4 rounded-lg flex justify-center items-center gap-2">
                                                  <BsArrowLeftCircle className='font-bold' /> Back
                                        </button>
                              </Link>
                              <div className="container mx-auto text-white">
                                        <div className="-mx-4 flex flex-wrap lg:justify-between">
                                                  ...
                                                  <div className="w-full lg:px-4 lg:w-1/2 xl:w-5/12">
                                                                      ...
                                                                      <form onSubmit={handleContactUs}>
                                                                                <div className="mb-6">
                                                                                          <input
                                                                                                    ...
                                                                                                    name='name'
                                                                                                    className="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none bg-transparent placeholder:text-white"
                                                                                          />
                                                                                </div>
                                                                                <div className="mb-6">
                                                                                          <input
                                                                                ...
                                                                                <div className="mb-6">
                                                                                          <textarea
                                                                                                    ...
                                                                                                    name='message'
                                                                                                    className="text-body-color border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none bg-transparent placeholder:text-white"
                                                                                          ></textarea>
                                                                                </div>
                                                                                <div>
                                                                                          <button
